...
contract Deploy_CordylineAccountFactory is Script {
    ...
    function run() public {
        ...
        bytes32 initCodeHash =
            keccak256(abi.encodePacked(type(CordylineAccountFactory).creationCode, abi.encode(owner, entryPoint)));
        ...
        CordylineAccountFactory factory = new CordylineAccountFactory{
        ...
        console.log("CordylineAccountFactory:", address(factory));
        console.log("CordylineAccount:", address(factory.ACCOUNT_IMPLEMENTATION()));
        console.log();
    ...
    function _addStakeForFactory(address factoryAddr) internal {
        ...
        CordylineAccountFactory(payable(factoryAddr)).addStake{value: stakeAmount}(unstakeDelaySec, stakeAmount);
